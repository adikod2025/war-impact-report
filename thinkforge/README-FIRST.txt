...
You need Node.js v22.5 or newer (https://nodejs.org). Nothing else to install.

Full instructions, including how to turn on the AI coach, are in INSTALL.md.
If anything goes wrong, run:  node scripts/doctor.mjs
